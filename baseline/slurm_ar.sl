...
TASKS_GPU0='associative_recall'
TASKS_GPU1='associative_recall'

OUTPUT_FILE_GPU0="results_${MODELS_GPU0}_${TASKS_GPU0}_1k_10k.csv"
# OUTPUT_FILE_GPU0="results_${MODELS_GPU0}_${TASKS_GPU0}.csv"
OUTPUT_FILE_GPU1="results_${MODELS_GPU1}_${TASKS_GPU1}_100k.csv"
# OUTPUT_FILE_GPU1="results_${MODELS_GPU1}_${TASKS_GPU1}.csv"
